        ...
        if(listCountEmployeesPhase.result && listCountEmployeesPhase.result.length > 0 && listCountCategory.result && listCountCategory.result.length > 0){
            return (
                <div style={{height:"90vh",overflow: 'auto', overflowX: 'hidden', padding:"50px 0"}}>  
                    ...
                    <div className="count-category-container row" style={{padding:"50px"}}>
                        <div className="count-category-left col-lg-8">
                            <div className="bar">
                                    <Bar
                                        data={{
                                            labels: ['KFC', 'CYBER'], 
                                            datasets:[
                                                {
                                                    label: 'Category',
                                                    data: [listCountCategory.result[0].COUNT_KFC,listCountCategory.result[0].COUNT_CYBER],
                                                    backgroundColor: [
                                                        'rgba(255, 99, 132, 0.2)',
                                                        'rgba(54, 162, 235, 0.2)',
                                                        'rgba(255, 206, 86, 0.2)',
                        ...
                        <div className="count-category-right col-lg-4">
                            <div className="pie">
                                <Pie
                                    data={{
                                        labels: ['KFC', 'CYBER'], 
